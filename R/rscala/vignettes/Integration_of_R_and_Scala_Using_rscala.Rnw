...
<<scalaScript1qnorm,engine="scala",engine.path=scalaInfo(s)$cmd,engine.opts=paste0('-cp ',scalaInfo(s)$classpath),comment="//">>=
val R = org.ddahl.rscala.RClient()
...
<<scalaScript1europe,engine="scala",engine.path=scalaInfo(s)$cmd,engine.opts=paste0('-cp ',scalaInfo(s)$classpath),comment="//">>=
val R = org.ddahl.rscala.RClient()
