...
\sdols{} package and, assuming \shallot{} is installed when \sdols{} is loaded,
the additional JAR files of \shallot{} will already available.  That is, the
\code{.onLoad} function for the \shallot{} package might be:
