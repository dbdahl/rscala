...
<<scalaScript0,engine="scala",engine.opts=paste0('-cp ',scalaInfo(s)$classpath),comment="//",eval=FALSE>>=
...
<<scalaScript1qnorm,engine="scala",engine.opts=paste0('-cp ',scalaInfo(s)$classpath),comment="//">>=
val R = org.ddahl.rscala.RClient()
...
<<scalaScript1europe,engine="scala",engine.opts=paste0('-cp ',scalaInfo(s)$classpath),comment="//">>=
val R = org.ddahl.rscala.RClient()
