...
\title{\textit{\Large Under Review\\\footnotesize Software Version: 2.3.3,\ \ Document ID: 2017-08-28}\\\vspace{5ex} Integration of \R and \Scala Using \rscala}
...
<<scalaScript1qnorm,engine="scala",engine.path=scalaInfo(s)$cmd,engine.opts=paste0('-nc -cp ',scalaInfo(s)$classpath),comment="//">>=
val R = org.ddahl.rscala.RClient()
...
<<scalaScript1europe,engine="scala",engine.path=scalaInfo(s)$cmd,engine.opts=paste0('-nc -cp ',scalaInfo(s)$classpath),comment="//">>=
val R = org.ddahl.rscala.RClient()
