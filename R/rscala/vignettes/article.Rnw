...
\title{\textit{\Large Under Review\\\footnotesize Software Version: 2.3.5-SNAPSHOT,\ \ Document ID: 2017-09-20}\\\vspace{5ex} Integration of \R and \Scala Using \rscala}
...
of \R with the \pkg{darksky}, \pkg{httr}, and \pkg{ggplot2} packages.  The web
